...
public class TugasAkhirApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		User user1 = new User();
		user1.setFirstName("muji");
		user1.setLastName("ono");
		user1.setUsername("muji");
		user1.setPassword(SecurityUtility.passwordEncoder().encode("p"));
		user1.setEmail("kasur.rusak404@gmail.com");
